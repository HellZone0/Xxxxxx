...
Tab3:Toggle({
    Title = "Black Screen",
    Desc = "Show HELLZONE HUB black screen",
    Icon = false,
    Type = false,
    Default = false,
    Callback = function(state)
        if state then
            ...
            ScreenGui.Name = "HELLZONE_BlackScreen"
            ...
            Text1.Text = "HELLZONE HUB | Fish It"
            ...
            if game.CoreGui:FindFirstChild("HELLZONE_BlackScreen") then
